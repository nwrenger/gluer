...
Below is a complete example demonstrating the use of `gluer` with `axum`. [Here](/tests/api.ts) is the generated output. You can also look into [this bigger project](https://github.com/wrenger/schiller-lib) which uses `gluer`.
