...
Below is a complete example demonstrating the use of `gluer` with `axum` or look into [this bigger project](https://github.com/wrenger/schiller-lib) or [this smaller project](https://github.com/nwrenger/shitboard)  which uses `gluer`:
